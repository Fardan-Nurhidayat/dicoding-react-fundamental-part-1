    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 p-6">
      {archivedNotes.length === 0 ? (
        <div className="col-span-full flex flex-col items-center justify-center py-16">
          ...
          <p className="text-gray-400 dark:text-gray-500 text-lg font-medium">No archived notes</p>
          <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">Your archived notes will appear here</p>
        </div>
      ) : (
